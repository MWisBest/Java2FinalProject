...
public class GameMessages {
	...
	public GameMessages() {
		...
		// Game Introduction
		messages.put("Start",
				"You were tasked to steal plans from the enemy before they could lay siege to your kingdom"
		...
		messages.put("44Index",
				"looking North you see where the gaurd's went"
						+ " looking South you see the wall to the end of the hallway"
						+ " looking forward to the East into an empty cell" + " going back South leads to your cell");
		...
		messages.put("24Index",
				"North through the door into the hallway you are met at an intersection"
		...
		messages.put("23B",
				"back East you come to the base of the stairs and can see the intersection in front of you");

		// fight the 1st guard that was pacing
		messages.put("22F",
				"You get to the top of the stairs and see a guard walking the halls and 2 guards at a door and the 1st gaurd comes at you");
		...
		messages.put("25F",
				"You continue East down a hallway continuing on East it looks like you see another intersection");
		...
		messages.put("26Index",
				"have come to an intersection" + " looking north you see a hallway that looks like a set of stairs"
		...
		messages.put("06F",
				"You walk to a room that outlooks the walls and on a table you see hastly drawn battle plans");
		...
		messages.put("27B",
				"the door behind you you return back to the building and continuing West will lead back too the 2nd intersection");

		// next intersection 4th intersection
		messages.put("28Index",
				"You are outside" + " looking West you can see the door back inside"
		...
		messages.put("48Index",
				"You have come into a battle with the guards around the fire and you can see the gate to the East and the path back North");
		...
		messages.put("18F",
				"You go north you are next to the wooden shed and there is a torch next to the shed and a path that continues north");
		...
		// 2
		messages.put("010Index",
				"You have entered the stable and can see horses and a door leading South and the exit going East");
